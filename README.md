...
* Sun Dec 31 2023 09:54:34 GMT-0800 (PST)
* Source doc: Javascript interview prep
...
* How is an asynchronous operation handled?
* async - await
* difference between handling promise using async-await vs then-catch
* map and set data structure
* map, filter and reduce
* differentiate between map and foreach
* modules(import/export)
* oop (classes, objects, prototypes, constructors, inheritance) refer tutorial below
* object
* this
* constructor function
* Commonly used methods from the Object class
* getter and setter
* prototype
* call, apply and bind
...
* async and defer
* api calls
* familiarise how to set breakpoints in browser
* String methods
* hoisting
* closure
* scope chain
...
* Prototype Object: The prototype of an object is accessible through the __proto__ property (deprecated) or the Object.getPrototypeOf() method. It represents the object from which the current object inherits its properties.
...
and use throttling when you have to make a request after a certain limit(delay). eg. req after every 2 secs. 

-rate of fire of a gun is an example of throttling.
